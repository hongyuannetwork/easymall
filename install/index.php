...
$dbinfo = array('dbhost'=>$hostname,'dbname'=>$db,'dbuser'=>$username,'dbpw'=>$password,'tablepre'=>$db_tablepre);
$admininfo = array('username'=>$admin_username,'password'=>$admin_pwd);  
	...
	case 3: //正在安装
		require(INSTALL_PATH.'/templates/step_3.html');
			...
			if($conn)
			{
				...
				//创建管理员
				mysql_query("INSERT INTO `".$dbinfo['tablepre']."admin` VALUES('1','".$admininfo['username']."','".md5(md5($admininfo['password']))."','','0','','0','true','127.0.0.1','".time()."');");
