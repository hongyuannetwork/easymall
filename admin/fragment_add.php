...
<body>
<div class="gray_header"> <span class="title">添加碎片数据</span> <span class="reload"><a href="javascript:location.reload();">刷新</a></span> </div>
<form name="form" id="form" method="post" action="fragment_save.php" onsubmit="return cfm_fragment();">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="form_table">
		<tr>
			...
			<td width="75%"><input type="text" name="title" class="class_input" id="title" />
