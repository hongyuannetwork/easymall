...
<form name="form" id="form" method="post" action="goodsflag_save.php?action=save">
	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="mgr_table">
		<tr align="center" class="thead">
			...
			<td width="35%" align="left">属性标识</td>
			<td width="10%">排序</td>
			<td width="10%">操作</td>
		</tr>
		<?php
		...
		<tr align="center" class="mgr_tr">
			...
			<td><a href="goodsflag_save.php?id=<?php echo $row['id']; ?>&orderid=<?php echo $row['orderid']; ?>&action=up"><img src="templates/images/up.gif" title="向上移动" /></a>
				<input type="text" name="orderid[]" id="orderid[]" class="input_gray_short" value="<?php echo $row['orderid']; ?>" />
				<a href="goodsflag_save.php?id=<?php echo $row['id']; ?>&orderid=<?php echo $row['orderid']; ?>&action=down"><img src="templates/images/down.gif" title="向下移动" /></a></td>
...
<div class="page_area">
	<div class="page_info">共有<span><?php echo $dosql->GetTableRow("#@__goodsflag"); ?></span>条记录</div>
</div>
</body>
</html>