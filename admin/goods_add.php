...
<form name="form" id="form" method="post" action="goods_save.php" onsubmit="return cfm_goods();">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="form_table">
		...
		<tr>
			...
			<td>市场价
				<input name="marketprice" type="text" id="marketprice" class="class_input" style="width:50px;" />
				&nbsp;&nbsp;销售价
				<input name="salesprice" type="text" id="salesprice" class="class_input" style="width:50px;" /></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input name="weight" type="text" class="input_short" id="weight" />
				kg</td>
		</tr>
		<tr>
