...
<form name="form" id="form" method="post" action="admin_save.php" onsubmit="return cfm_admin();">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="form_table">
		...
		<tr>
			...
			<td><input type="text" name="answer" class="class_input" id="answer" /></td>
		</tr>
		<tr>
			<td height="35" align="right">昵　称：</td>
			<td><input type="text" name="nickname" class="class_input" id="nickname" />
		...
		<tr>
			...
			<td><select name="levelname" id="levelname">
				...
				foreach(array('0'=>'超级管理员', '1'=>'普通管理员', '2'=>'文章发布员') as $k=>$v)
				{
					...
					{
						if($k != 0) echo "<option value=\"$k\">$v</option>";		
					}
				}
				?>
				</select></td>
