...
<form name="form" id="form" method="post" action="adtype_save.php" onsubmit="return cfm_adtype();">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="form_table">
		...
		<tr>
			...
			<td><input type="text" name="width" class="input_shorts" id="width" value="<?php echo $row['width']; ?>" />
			  宽度(px)
				&nbsp;&nbsp;
			  <input type="text" name="height" class="input_shorts" id="height" value="<?php echo $row['height']; ?>" />
			  高度(px)</td>
		</tr>
		<tr>
