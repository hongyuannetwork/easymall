...
if($c == 'login')
{
	...
	{
		require(PHPMYWIND_TEMP.'/default/member/login.php');
		exit();
	}
}
...
if($c == 'default')
{
	require(PHPMYWIND_TEMP.'/default/member/default.php');
	exit();
}

else if($c == 'avatar')
{		
	require(PHPMYWIND_TEMP.'/default/member/avatar.php');
	exit();
}

else if($c == 'edit')
{		
	require(PHPMYWIND_TEMP.'/default/member/edit.php');
	exit();
}

else if($c == 'comment')
{	
	require(PHPMYWIND_TEMP.'/default/member/comment.php');
	exit();
}

else if($c == 'favorite')
{
	require(PHPMYWIND_TEMP.'/default/member/favorite.php');
	exit();
}

else if($c == 'order')
{
	require(PHPMYWIND_TEMP.'/default/member/order.php');
	exit();
}

else if($c == 'ordershow')
{
	require(PHPMYWIND_TEMP.'/default/member/ordershow.php');
	exit();
}

else if($c == 'msg')
{
	require(PHPMYWIND_TEMP.'/default/member/msg.php');
	exit();
}

else if($c == 'reg')
{
	require(PHPMYWIND_TEMP.'/default/member/reg.php');
	exit();
}

else if($c == 'findpwd')
{
	require(PHPMYWIND_TEMP.'/default/member/findpwd.php');
	exit();
}
...
else if($c == 'findpwd2')
{
	...
	{
		require(PHPMYWIND_TEMP.'/default/member/findpwd2.php');
		exit();
	}
}
...
else if($c == 'findpwd3')
{
	...
	{
		require(PHPMYWIND_TEMP.'/default/member/findpwd3.php');
		exit();
	}
}
