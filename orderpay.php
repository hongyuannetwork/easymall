...
require('data/alipay/alipay.config.php');
require('data/alipay/lib/alipay_submit.class.php');
...
/**************************请求参数**************************/
        ...
        //必填，不能修改
        //服务器异步通知页面路径
        $notify_url = $cfg_weburl.$cfg_webpath.'/data/alipay/notify_url.php';
        //需http://格式的完整路径，不能加?id=123这类自定义参数

        //页面跳转同步通知页面路径
        $return_url = $cfg_weburl.$cfg_webpath.'/data/alipay/return_url.php';
